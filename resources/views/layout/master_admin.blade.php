      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="{{ Request::is('admin-oke') ? 'active' : '' }}">
            ...
            {{--  <li class="{{ Request::is('admin-oke/type-product*') ? 'active' : '' }}">
                <a href="">
                    <i class="fa fa-spinner"></i> <span>TyPe Product</span>
                </a>
            </li>
            <li class="{{ Request::is('admin-oke/attribute*') ? 'active' : '' }}">
                <a href="">
                    <i class="glyphicon glyphicon-asterisk"></i> <span>Attribute</span>
                </a>
            </li>
            <li class="{{ Request::is('admin-oke/product*') ? 'active' : '' }}">
                <a href="">
                    <i class="fa fa-fw fa-anchor"></i> <span>Product</span>
                </a>
            </li>
            <li class="{{ Request::is('admin-oke/user*') ? 'active' : '' }}">
                <a href="">
                    <i class="fa fa-users"></i> <span>User</span>
                </a>
            </li>
            <li class="{{ Request::is('admin-oke/transaction*') ? 'active' : '' }}">
                <a href="">
            ...
            <li class="{{ Request::is('admin-oke/slide*') ? 'active' : '' }}">
                <a href="">
